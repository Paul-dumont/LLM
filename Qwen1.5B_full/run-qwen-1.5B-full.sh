...
#
# ==================== SLURM JOB CONFIG ====================
#SBATCH --job-name=qwen1.5b
#SBATCH --output=Qwen1.5B_full/logs/qwen-1.5b-full-%j.out
#SBATCH --error=Qwen1.5B_full/logs/qwen-1.5b-full-%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="Qwen1.5B_full/Qwen2.5-1.5B-full.py"
